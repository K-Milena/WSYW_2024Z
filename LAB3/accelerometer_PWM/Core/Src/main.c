...
/**
  ...
  *
  *`Stwórz układ wykorzystujący akcelerometr lub żyroskop do wykrywania poziomu i zapalający
  *	diodę wskazującą kierunek przechylenia płytki.
  *
  ******************************************************************************
  */
